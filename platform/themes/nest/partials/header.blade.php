...
<head>
    ...
    <style>
        :root {
            ...
            --color-brand: {{ theme_option('color_brand', '#23AED8') }};
            --color-brand-rgb: {{ implode(',', BaseHelper::hexToRgb(theme_option('color_brand', '#3BB77E'))) }};
            --color-brand-dark: {{ theme_option('color_brand_dark', '#23AED8') }};
                ...
                <div class="header-info header-info-right">
                    <ul>
                        @if (theme_option('hotline'))
                            <li>{{ __('Call Us:') }} &nbsp;<strong class="text-brand1"> {{ theme_option('hotline') }}</strong></li>
                        @endif
                    ...
                    <div class="search-style-2">
                        <form action="{{ route('public.products') }}" class="form--quick-search" data-ajax-url="{{ route('public.ajax.search-products') }}" method="GET">
                            {{-- <div class="form-group--icon position-relative">
                                <div class="product-cat-label">{{ __('') }}</div>
                        ...
                        <div class="header-action-2">
                            ...
                            <div class="header-action-icon-2">
                                <a href="{{ route('public.compare') }}">
                                    <img class="svgInject" alt="{{ __('Track Orders') }}" src="{{ Theme::asset()->url('imgs/theme/icons/icon-compare.svg') }}" />
                                    <span class="pro-count blue compare-count">{{ Cart::instance('Track Orders')->count() }}</span>
                                </a>
                                <a href="{{ route('public.orders.tracking') }}"><span class="lable">{{ __('Track Orders') }}</span></a>
                            </div>
                        @endif
